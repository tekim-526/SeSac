...
struct WeatherAPIManager {
    ...
    typealias weatherInfo = (weather :String, iconURL: String, temp: Double, humidity: Int, country: String)
    ...
    func getWeather(completionHandler: @escaping (weatherInfo) -> ()) {
        AF.request(url, method: .get).validate().responseData { response in
            ...
            case .success(let value):
                ...
                weatherInfo = (json["weather"][0]["main"].stringValue, iconURL, json["main"]["temp"].doubleValue - 273.15, json["main"]["humidity"].intValue, json["sys"]["country"].stringValue)
