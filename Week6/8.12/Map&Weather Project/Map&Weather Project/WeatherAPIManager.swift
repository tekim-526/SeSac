...
struct WeatherAPIManager {
    ...
    typealias weatherInfo = (weather :String, iconURL: String, temp: Double, temp_max: Double, temp_min: Double)
    ...
    func getWeather(completionHandler: @escaping (weatherInfo) -> ()) {
        AF.request(url, method: .get).validate().responseData { response in
            ...
            case .success(let value):
                ...
                weatherInfo = (json["weather"][0]["main"].stringValue, iconURL, json["main"]["temp"].doubleValue - 273.15, json["main"]["temp_min"].doubleValue - 273.15, json["main"]["temp_max"].doubleValue - 273.15)
